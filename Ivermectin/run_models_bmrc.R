...
if(model_settings$cov_matrices[i]==0){
  ...
  analysis_data_stan$x_intercept = cov_matrices$X_int[[model_settings$cov_matrices[i]]]
  analysis_data_stan$K_cov_intercept=ncol(analysis_data_stan$x_intercept)
  analysis_data_stan$x_slope = cov_matrices$X_slope[[model_settings$cov_matrices[i]]]
