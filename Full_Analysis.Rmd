...
* Model 2: whole shebang with covariate adjustment
* Model 3: Non-linear model (up and then down)
...
* Variant (WHO variants of concern) - when available
* Serology rapid test (+/-)
...
#   params_var[[mm]]=
#     summary(out[[mm]],pars=c('sigma_logvl'))$summary[,c('mean','2.5%','97.5%')]
# }
# params_var[[mm+1]]=
#   summary(out_non_lin,pars=c('sigma_logvl'))$summary[,c('mean','2.5%','97.5%')]
# 
# params_var_RE = list()
# for(mm in 1:length(thetas)){
#   params_var_RE[[mm]]=
