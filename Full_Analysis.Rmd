...
- Vaccinated: integer number of doses received (any manufacturer)
...
```{r individ_fits}
par(las=1, mfrow=c(3,3), mar=c(4,3,1,1),bty='n', cex.lab=1.5, cex.axis=1.5,family='serif')
...
```{r}
par(mfrow=c(1,2), cex.lab=1.5, cex.axis=1.5,family='serif')
