...
#SBATCH -D /well/moru-batty/users/gka292/PLATCOV-SAP/Optimal_Follow_Up
#SBATCH -J res
#SBATCH -n 4
...
Rscript /well/moru-batty/users/gka292/PLATCOV-SAP/Optimal_Follow_Up/run_models_optimal_follow_up.R ${SLURM_ARRAY_TASK_ID} --no-save --no-restore
echo "finished="`date`
exit 0