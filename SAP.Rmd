...
lin_mod = stan_model(file = 'Linear_model_tdist.stan')
...
if(RUN_MODELS){
  ...
  out = sampling(lin_mod, data=c(stan_data, my_priors), 
...
```{r individ_fits}
par(las=1, mfrow=c(3,3), mar=c(4,4,1,1),bty='n', cex.lab=1.3, cex.axis=1.3,family='serif')
