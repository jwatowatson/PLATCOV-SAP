...
#SBATCH -D /well/moru-batty/users/gka292/PLATCOV-SAP/Simulation_power_analysis
#SBATCH -J res
#SBATCH -n 4
...
Rscript /well/moru-batty/users/gka292/PLATCOV-SAP/Simulation_power_analysis/run_sample_size_calculations.R ${SLURM_ARRAY_TASK_ID} --no-save --no-restore
echo "finished="`date`
exit 0