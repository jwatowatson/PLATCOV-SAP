...
```{r}
plot_name <- paste0(prefix_dropbox, "/Interim Analysis Reports/Plots_", interim_version, "/", intervention,  "_recruitment.pdf")

if(intervention == "interim_all"){wd = 12; ht = 6}else{wd = 8; ht = 4}

pdf(plot_name, width = wd, height = ht)
timeline
dev.off()
```
...
```{r}
unblinded_arms <- c("Nitazoxanide", "Metformin")
...
```{r}
plot_name <- paste0(prefix_dropbox, "/Interim Analysis Reports/Plots_", interim_version, "/", intervention, "_trt.pdf")
